...
import com.anggriawans.userseduhspace.databinding.ActivityDineInBinding
...
class DineInActivity : AppCompatActivity() {
    lateinit var binding: ActivityDineInBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDineInBinding.inflate(layoutInflater)
        ...
        binding.placeMyOrder.setOnClickListener {
            ...
            tableNumber = binding.tableNumber.text.toString().trim()
            phone = binding.phone.text.toString().trim()
            if (name.isBlank() || tableNumber.isBlank() || phone.isBlank()) {
    ...
    private fun placeOrder() {
        ...
        val orderDetails = OrderDetails(
            ...
            "", // address (kosongkan karena tidak digunakan di DineIn)
